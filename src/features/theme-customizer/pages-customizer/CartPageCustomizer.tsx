...
import CartProductsStyle from "../theme-sections/cart/CartProductsStyle";

export default function CartPageCustomizer() {
  const { t } = useTranslation();

  return (
    <Accordion type="single" collapsible defaultValue="cart-page">
      <AccordionItem value="cart-page">
