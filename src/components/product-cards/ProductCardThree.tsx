...
export default function ProductCardThree() {
  ...
  return (
    <article
      ...
      style={{ backgroundColor: colors.product_card_bg }}
    >
      <div className="flex items-center gap-2 relative">
        ...
        <button
          className="absolute w-8 h-8 bottom-2 left-2 rounded-full flex items-center justify-center"
          style={{ backgroundColor: colors.primary }}
        >
          <img src="/shopping-basket-add.svg" alt="cart" />
        </button>

        <button className="absolute w-8 h-8 top-2 right-2 rounded-full flex items-center justify-center bg-[#FFFFFF4D]">
